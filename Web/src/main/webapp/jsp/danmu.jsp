...
<script type="text/babel">
                    ...
                    <div className="commenter-item">
                        <div className="commenter-item-header">
                            <div>{this.props.comment.name}:
                                <div className="commenter-item-header-datetime">{this.props.comment.date}</div>
                            </div>
                        </div>
    ...
    var Commenter =React.createClass({
        getInitialState:function () {
            var comments =[{name:'ss',date:'2016年9月21日, PM 05:36:41',content:"今晚月色真美"},{name:'ss',date:'2016年9月21日, PM 05:36:41',content:"今晚月色真美"}];
